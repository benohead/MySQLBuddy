...
public class ConfigDialog extends JDialog {
        ...
        contentPanel.setLayout(new BorderLayout(0, 0));
        {
            ...
            contentPanel.add(tabbedPane);
            {
                ...
                }
                {
                    ...
                    {
                        defaultPortLabel = new JLabel("(default: 3306)");
                    }
                ...
                okButton.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent arg0) {
                        try {
                            ...
                            MySQLBuddyApplication.handleException(e);
                        }
                        catch (IOException e) {
                            MySQLBuddyApplication.handleException(e);
                        }
    ...
    protected void save() throws FileNotFoundException, IOException {
        ...
        MySQLBuddyApplication.servers = servers;
        MySQLBuddyApplication.writeServersToFile();
    }
